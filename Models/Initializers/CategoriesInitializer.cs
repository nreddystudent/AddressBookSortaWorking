...
namespace ContactBook.Models
{
    public class CategoriesInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            SqlCommand command = new SqlCommand("Create View ContactsView AS SELECT Contacts.[First Name], Contacts.[ContactID], Contacts.[Last Name], Contacts.Email, Contacts.[Phone Number], Contacts.Favourite, Contacts.UserID, Contacts.CategoryId, Categories.CategoriesID, Categories.Category AS Categories FROM Contacts JOIN Categories ON Contacts.CategoryId = Categories.CategoriesId", conn);
